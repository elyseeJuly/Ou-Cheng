...
> **中华文化数字化之基石**
>
> 感谢该项目及其所有贡献者，将浩如烟海的古典诗词转化成结构化的数字财富，使得「偶成」能够站在巨人的肩膀上，为现代创作者连接千年文脉。如果您在「偶成」的使用中通过 AI 审计发现了古籍数据漏洞，请务必利用我们的纠错功能协助其完善。
...
3. **API Key**：请在 `.env.local` 或「设置」页面中录入您的大模型 [API Key](https://aistudio.google.com/)。
